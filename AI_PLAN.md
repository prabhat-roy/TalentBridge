# AI_PLAN.md â€” TalentBridge (Human Capital Management Platform)
...
- CV / rÃ©sumÃ© NLP â€” extract skills, education, experience; suggest
  matches without making the final hire decision.
- Attrition + flight-risk prediction â€” early intervention.
- Pay-equity analytics â€” k-anonymised, regulator-ready.
- Performance review summarisation â€” manager-assist, not auto-write.
- Skills inference + learning recommendations â€” internal mobility.
- Multilingual employee chatbot â€” leave, payroll, policy.
...
|---|----------|--------|-------------|----------------|
| 1 | CV / rÃ©sumÃ© parsing + skill extraction | recruitment | Donut + LayoutLMv3 + Llama 3.1 70B + skill-KG | <3 s/CV |
...
`talent-architect` â€” researches AI tooling, proposes services, on-boards
...
Respond â†’ Upgrade â†’ Report. Plus a fairness-audit gate: every
...
```
ai-platform/
â”œâ”€â”€ cluster: talent-ai-{aws,gcp,azure}    â† cloud GPU pool, regional sharding
â”œâ”€â”€ namespace: talent-ai-control           â† Paperclip
â”œâ”€â”€ namespace: talent-ai-agents            â† OpenClaw runtime
â”œâ”€â”€ namespace: talent-ai-sandbox           â† NemoClaw â€” strict HR fairness guardrails
â”œâ”€â”€ namespace: talent-ai-models            â† vLLM, Ollama, LiteLLM, Triton
â”œâ”€â”€ namespace: talent-ai-data              â† Qdrant, Weaviate, MinIO, MLflow
â”œâ”€â”€ namespace: talent-ai-obs               â† Langfuse, Phoenix
â””â”€â”€ namespace: talent-ai-pipelines         â† Argo Workflows
```
...
- Region-strict â€” EU employee data never leaves EU; same for IN, US,
...
| 5 | Per-service Tier-2 agents (recruitment â†’ core-hr â†’ payroll first) |
...
- Cloud infra: $4,800 â€“ $7,500 / month per primary cloud (region-sharded raises overall)
